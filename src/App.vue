...
<template>
  <div class="min-h-screen">
    <!-- Sticky top bar (KunUI docs-style) -->
    <header
    ...
    >
      ...
      <div class="flex items-center gap-3">
        <router-link
          to="/editor"
          class="text-default-500 hover:text-foreground flex items-center gap-1.5 text-sm transition-colors"
        >
    ...
    <div class="mx-auto flex max-w-7xl" style="height: calc(100vh - 57px);">
      ...
      <!-- Main content -->
      <main class="min-w-0 flex-1 overflow-y-auto px-6 py-10 lg:px-10">
        <router-view />
      </main>
    </div>
  </div>
